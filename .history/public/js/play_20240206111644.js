...
function setQuestion(questionObject) {
    ...
    setInterval(() => {
        for (let i = 0; i < 4; i++) {
            container.option1.innerHTML = `<input type="radio" name="answer" id="1" value="1" /><span class="option-color" id="option-color1">A:&nbsp;</span> ${options[i]} <span class="checked"></span>`;
        }
    }, 5000);
